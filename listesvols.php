...
$reqInsert='insert into vols (destination,prix,date_depart,date_arrivee,statement) values ("'.$_POST["destination"].'","'.$_POST["prix"].'","'.$_POST["date_depart"].'","'.$_POST["date_arrivee"].'","'.$_POST["statement"].'")';
echo $reqInsert;
...
<html lang="en">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-user"></i></i></i>Clients</a>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Vols <small>Vols Lists</small></h3>
              </div>
  ...
  { ?>
                        ...
                        <td><?php echo $vols["prix"]?></td> 
                        <td><?php echo $vols["date_depart"]?></td> 
                        <td><?php echo $vols["date_arrivee"]?></td> 
                        <td><?php echo $vols["statement"]?></td> 
                         
                          <td>
                          <a href="EditVols.php?id=<?php  echo $vols["id_vol"]?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                          <a href="Supprimervol.php?id=<?php  echo $vols["id_vol"]?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
		  ...
		  <div class="title_left">
                <h3>Vols <small>Insert Vol</small></h3>
              </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="listesvols.php" method="POST">
