...
$reqInsert='insert into hotels (name,etoile,total_chambre,phone,statement) values ("'.$_POST["name"].'","'.$_POST["etoile"].'","'.$_POST["total_chambre"].'","'.$_POST["phone"].'","'.$_POST["statement"].'")';
echo $reqInsert;
...
<html lang="en">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Hotels <small>Hotels Lists</small></h3>
              </div>
  ...
  { 
              ...
              <?php echo $hotel["statement"]?>
                          ...
                          <td>
                            <a href="EditHotel.php?id=<?php  echo $hotel["id_hotel"]?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
							<a href="SupprimerHotel.php?id=<?php  echo $hotel["id_hotel"]?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
		  ...
		  <div class="title_left">
                <h3>Hotels <small>Insert Hotel</small></h3>
              </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="listesHotels.php" method="POST">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='optional'  data-validate-length-range="5,15" name="name" type="text" /></div>
                                        </div>
										<div class="field item form-group">
										 ...
										 <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='optional' name="last" data-validate-length-range="5,15" type="text" value="0"/></div>
                                        </div>
										<div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Phone_Number<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='optional' name="phone"  type="text" /></div>
                                        </div>
