...
$reqInsert='update reservations set date_creation="'.$_POST["date_creation"].'",id_client="'.$_POST["id_client"].'",id_hotel="'.$_POST["id_hotel"].'",id_vol="'.$_POST["id_vol"].'",prix="'.$_POST["prix"].'",statement="'.$_POST["statement"].'" where id_reservation= '.$_POST["id_reservation"];
echo $reqInsert;
$idcom->exec($reqInsert);
header("location:listesReservation.php");
}
$requete2="SELECT * FROM reservations where id_reservation=".$_GET["id"];
       ...
       <!-- top navigation -->
        ...
        <div class="right_col" role="main">
		  ...
		  <div class="title_left">
                <h3>Reservation <small>Edit Reservation</small></h3>
              </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="EditReservation.php?id=<?php echo $_GET["id"]?>" method="POST" >
                                    ...
                                    <div class="field item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="birthday" class="date-picker form-control" placeholder="dd-mm-yyyy"name="date_creation" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)"value="<?php echo $detail["date_creation"]?>">
                                            <script>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <select class="form-control" name="id_client"value="<?php echo $detail["id_client"]?>">
										...
										<div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <select class="form-control" name="id_hotel"value="<?php echo $detail["id_hotel"]?>">
										...
										<div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <select class="form-control" name="id_vol"value="<?php echo $detail["id_vol"]?>">
