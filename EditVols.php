...
$reqInsert='update vols set destination="'.$_POST["destination"].'",prix="'.$_POST["prix"].'",date_depart="'.$_POST["date_depart"].'",date_arrivee="'.$_POST["date_arrivee"].'",statement="'.$_POST["statement"].'" where id_vol= '.$_POST["id_vol"];
echo $reqInsert;
$idcom->exec($reqInsert);
header("location:listesvols.php");
}
$requete2="SELECT * FROM vols where id_vol=".$_GET["id"];
       ...
       <!-- top navigation -->
        ...
        <div class="right_col" role="main">
		  ...
		  <div class="title_left">
                <h3>Vols <small>Edit Vol</small></h3>
              </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form  action="EditVols.php?id=<?php echo $_GET["id"]?>" method="POST">
