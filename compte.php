...
<form method="POST" onsubmit="return erreur()" action="paiementfacture.php">
									...
									<div class="card-body">
										<form class="form-horizontal"  >
											<div class="form-group row">
												...
												<div class="col-md-9">
												<form name="num_compte1">	<input name="num" id="num_compte" type="number" class="form-control" onblur="verifnom(this);"> </form>
												</div>
											</div>
												...
												<div class="col-md-9">
                                                    <?php $prix =$_POST['prix']; ?>
													<input class="form-control"  id="solde" type=hidden name="prix" value="<?php echo $prix; ?>">
												</div>
											</div>
