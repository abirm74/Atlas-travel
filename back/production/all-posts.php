        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><img src="images/ahmed.ico"> <span>Atlas Travel </span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i>Blog <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li><a href="post-new.php">Add New</a></li> 
                      ...
                      <li><a href="add-categories.php">Add Categorie </a></li>
                    </ul>
                  </li>         
                </ul>
              </div>   
            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>Atlas Travel <small>Welcome </small></h3>
                  </div>
                    ...
                    if($_SESSION["user_role"]=="Admin")
                    {
                      ...
                      if (mysqli_num_rows($result) > 0)
                      {
                         ...
                         //   echo "<td>".$row['description']."</td>";
                            echo "<td><a href=\"delete-posts.php?post_id=$row[post_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a> | <a href=\"edit-posts.php?post_id=$row[post_id]\">Edit</a> </td>";
                            echo "</tr>";
                          }
                      }
                      else
