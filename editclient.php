...
$reqInsert='update client set first_name="'.$_POST["first_name"].'",last_name="'.$_POST["last_name"].'",telephone="'.$_POST["telephone"].'",email="'.$_POST["email"].'",statement="'.$_POST["statement"].'" where cin= '.$_POST["cin"];
echo $reqInsert;
$idcom->exec($reqInsert);
header("location:listesclient.php");
}
$requete2="SELECT * FROM client where cin=".$_GET["id"];
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                <div class="menu_section">
                    ...
                    <ul class="nav side-menu">
                      ...
                      <li><a href="listesclient"><i class="fa fa-user"></i></i></i>Clients</a>
       ...
       <!-- top navigation -->
        ...
        <div class="right_col" role="main">
		  ...
		  <div class="title_left">
                <h3>Clients <small>Edit Client</small></h3>
              </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form  action="editclient.php?id=<?php echo $_GET["id"]?>" method="POST">
